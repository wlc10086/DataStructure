...
<img src="../images/ch08-01-01-01.jpg" alt="错误树结构展示" style="zoom:80%;" />  
...
3）凹入表示法  
4）广义表表示法  
<img src="../images/ch08-01-03-01.png" alt="树的表示方法" style="zoom:120%;" />  
...
### 1.4.1 双亲存储表示法
**双亲存储表示法（parent tree）**一般采**用顺序存储结构**实现。即用一组连续的存储空间来存储树的结点，每个结点包括数据元素的值本身和指向结点双亲位置的指针（伪指针）。双亲存储表示法的定义如下：  
...
重要操作P：
  ...
  Traversal(T)；
    初始条件：二叉树T存在。 
    操作结果：遍历，按某顺序访问每个结点；(可分为前序，中序，后序，层序)
}endADT  BinaryTree 
```
...
### 2.9.1 二叉查找树
二叉查找树，又称为二叉排序树，二叉搜索树，请查看ch10中二叉排序树部分。
...
<img src="../images/ch08-02-09-02.png" alt="img" style="zoom:70%;" />  
...
<img src="../images/ch08-02-09-03.png" alt="img" style="zoom:100%;" />  
